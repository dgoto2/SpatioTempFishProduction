PRO WalleyeSizeStruc

PRINT, 'a function to create lake-year-specific age-length keys of walleye stocks in Wisconsin, USA'
PRINT, 'Created: March, 2014'
PRINT, 'Updated: April, 19, 2014'

tstart = SYSTIME(/seconds); starting point for computation time
...
CD, 'C:\Users\Daisuke\Desktop\Walleye outputs'; Directory; F:\SNS_SEIBM
  ...
  Nageclass = 28; number of age class
...
FOR i = 0L, N_ELEMENTS(uniqWBIC_Year)-1L DO BEGIN
  ...
  INDEX_growthdata = WHERE(WBIC_Year[*] EQ uniqWBIC_Year[i], INDEX_growthdatacount)
  ; WBIC_Year2 - WBIC_year from the input data
  ; uniqWBIC_year - hypothetical WBIC_years created for loops
  ;paramset[22L, i] = INDEX_growthdatacount
  print,'Number of fish in each WBIC_year',INDEX_growthdatacount
...
;    ENDFOR
  ...
  IF INDEX_growthdatacount GT 0 THEN BEGIN; if there is fish in a given WBIC_year
        ...
        ; store information in the output array
        ...
        ; length bin 1
        ; store basic data information in the output array
        WAE_length_bin[0, i*NumLengthBin+adj] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[4, i*NumLengthBin+adj] = Max(length[INDEX_growthdata]); max length all
        WAE_length_bin[5, i*NumLengthBin+adj] = Min(length[INDEX_growthdata]); min length all
        WAE_length_bin[6, i*NumLengthBin+adj] = Max(age[INDEX_growthdata]); max age all
        WAE_length_bin[7, i*NumLengthBin+adj] = Min(age[INDEX_growthdata]); min age all
        WAE_length_bin[8, i*NumLengthBin+adj] = 99
        WAE_length_bin[9, i*NumLengthBin+adj] = SizeLT100count; number of fish <100
        ...
        PRINT, 'SizeLT100', TOTAL(WAE_length_bin[10L:36, i*NumLengthBin+adj])
         ...
         ; length bin 2 
        WAE_length_bin[0, i*NumLengthBin+adj+1L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
       ...
       ; length bin 3
        WAE_length_bin[0, i*NumLengthBin+adj+2L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        ; length bin 4
        WAE_length_bin[0, i*NumLengthBin+adj+3L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+4L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+5L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+6L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+7L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+8L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+9L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+10L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+11L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+12L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+13L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+14L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+15L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+16L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+17L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+18L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+19L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+20L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+21L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+22L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+23L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+24L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+25L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+26L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+27L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+28L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+29L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+30L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+31L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        age0Size700to720 = WHERE((Age_Gro[Size700to720] EQ 0), Age0Size700to720count)
        age1Size700to720 = WHERE((Age_Gro[Size700to720] EQ 1), Age1Size700to720count)
        age2Size700to720 = WHERE((Age_Gro[Size700to720] EQ 2), AGE2Size700to720count)
        age3Size700to720 = WHERE((Age_Gro[Size700to720] EQ 3), AGE3Size700to720count)
        age4Size700to720 = WHERE((Age_Gro[Size700to720] EQ 4), AGE4Size700to720count)
        age5Size700to720 = WHERE((Age_Gro[Size700to720] EQ 5), AGE5Size700to720count)
        age6Size700to720 = WHERE((Age_Gro[Size700to720] EQ 6), AGE6Size700to720count)
        age7Size700to720 = WHERE((Age_Gro[Size700to720] EQ 7), AGE7Size700to720count)
        age8Size700to720 = WHERE((Age_Gro[Size700to720] EQ 8), AGE8Size700to720count)
        age9Size700to720 = WHERE((Age_Gro[Size700to720] EQ 9), AGE9Size700to720count)
        age10Size700to720 = WHERE((Age_Gro[Size700to720] EQ 10), AGE10Size700to720count)
        age11Size700to720 = WHERE((Age_Gro[Size700to720] EQ 11), AGE11Size700to720count)
        AGE12Size700to720 = WHERE((Age_Gro[Size700to720] EQ 12), AGE12Size700to720count)
        AGE13Size700to720 = WHERE((Age_Gro[Size700to720] EQ 13), AGE13Size700to720count)
        AGE14Size700to720 = WHERE((Age_Gro[Size700to720] EQ 14), AGE14Size700to720count)
        AGE15Size700to720 = WHERE((Age_Gro[Size700to720] EQ 15), AGE15Size700to720count)
        age16Size700to720 = WHERE((Age_Gro[Size700to720] EQ 16), Age16Size700to720count)
        age17Size700to720 = WHERE((Age_Gro[Size700to720] EQ 17), AGE17Size700to720count)
        age18Size700to720 = WHERE((Age_Gro[Size700to720] EQ 18), AGE18Size700to720count)
        age19Size700to720 = WHERE((Age_Gro[Size700to720] EQ 19), AGE19Size700to720count)
        age20Size700to720 = WHERE((Age_Gro[Size700to720] EQ 20), AGE20Size700to720count)
        age21Size700to720 = WHERE((Age_Gro[Size700to720] EQ 21), AGE21Size700to720count)
        age22Size700to720 = WHERE((Age_Gro[Size700to720] EQ 22), AGE22Size700to720count)
        age23Size700to720 = WHERE((Age_Gro[Size700to720] EQ 23), AGE23Size700to720count)
        age24Size700to720 = WHERE((Age_Gro[Size700to720] EQ 24), AGE24Size700to720count)
        age25Size700to720 = WHERE((Age_Gro[Size700to720] EQ 25), AGE25Size700to720count)
        age26Size700to720 = WHERE((Age_Gro[Size700to720] EQ 26), AGE26Size700to720count)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+32L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+33L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+34L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+35L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
        ...
        WAE_length_bin[0, i*NumLengthBin+adj+36L] = WBIC_year[INDEX_growthdata[0]]; WBIC_year (abbrev)
       ...
       IF SizeGE800count GT 0 THEN BEGIN
        ...
        PRINT, 'Total N of fish', TOTAL(WAE_length_bin[10L:36, i*NumLengthBin+adj:i*NumLengthBin+adj+36L])
        ...
        IF Size640to660count GT 0 THEN BEGIN
          ...
          WAE_length_bin[41, i*NumLengthBin+adj+28L] = 99
        ...
        PRINT, 'Total N of MALES', TOTAL(WAE_length_bin[43L:69, i*NumLengthBin+adj:i*NumLengthBin+adj+36L])
        ...
        ENDIF
        PRINT, 'Size340to360F', TOTAL(WAE_length_bin[76L:102, i*NumLengthBin+adj+14L]), Size340to360countF
        ...
        ENDIF
        PRINT, 'Size740to760F', TOTAL(WAE_length_bin[76L:102, i*NumLengthBin+adj+33L]),Size740to760countF
        ...
        PRINT, 'Total N of FEMALES', TOTAL(WAE_length_bin[76L:102, i*NumLengthBin+adj:i*NumLengthBin+adj+36L])
        PRINT, 'ALL', WAE_length_bin[70L:102L, i*NumLengthBin+adj:i*NumLengthBin+adj+36L]
...
Data2 = WAE_size_age;[*, INDEX_length_age]

filename2 = 'Output_walleye_length-at-age_summary.csv'
;****the files should be in the same directory as the "IDLWorksapce81" default folder.****
