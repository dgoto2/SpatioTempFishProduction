PRO WalleyeSizeStrucRegion
  ; to determine region-wide age structure of walleye stocks in Wisconsin, USA
  ...
  paramset = FLTARR(156L); an array for growth model parameters
  WAE_size_age = FLTARR(409L); an array for mean size-at-age
  NumLengthBin = 37L; numebr of length bins in a default array (NEED TO CORRECT)
  Nageclass = 28;
  WAE_length_bin=fltarr(37*3L, NumLengthBin)
      Numageclass = N_ELEMENTS(UNIQ(FIX(AGE), SORT(FIX(AGE), /L64)))
      Maxageclass = Max(AGE)
      Minageclass = Min(AGE)
      ...
      IF malecouNt gt 0 then begin
        NumageclassM = N_ELEMENTS(UNIQ(FIX(AGE[[male]]), SORT(FIX(AGE[[male]]), /L64)))
        MaxageclassM = Max(AGE[[male]])
        MinageclassM = Min(AGE[[male]])
      endif
      ; age information for females
      if femalecount gt 0 then begin
        NumageclassF = N_ELEMENTS(UNIQ(FIX(AGE[[female]]), SORT(FIX(AGE[[female]]), /L64)))
        MaxageclassF = Max(AGE[[female]])
        MinageclassF = Min(AGE[[female]])
      endif
       
       i=0
      ;paramset[0, i] = uniqWBIC[i]; WBIC
      paramset[1, i] = N_ELEMENTS(Length_Gro); N of fish
      ;paramset[2, i] = WBIC[[0]]; WBIC
      ;paramset[3, i] = SurveyYear[[0]]; year
      ;PRINT, 'Observed length', Length_Gro
      ;PRINT, 'Observed age', Age_Gro
      print, 'N of fish', paramset[1, *]
      ;print, 'WBIC', paramset[2, i]
      ;print, 'Year', paramset[3, i]
      print, 'Max length (mm)', Max(length)
      print, 'Min length (mm)', Min(length)
      print, 'Female max length (mm)', Max(length[[female]])
      print, 'Female min length (mm)', Min(length[[female]])
      print, 'Male max length (mm)', Max(length[[male]])
      print, 'Male min length (mm)', Min(length[[male]])
      ...
      WAE_length_bin[0, i*NumLengthBin+adj] = WBIC[[0]]; WBIC
      WAE_length_bin[1, i*NumLengthBin+adj] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+1L] = WBIC[[0]]; WBIC
      WAE_length_bin[1, i*NumLengthBin+adj+1L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+1L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+1L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+1L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+1L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+1L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+1L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+2L] = WBIC[[0]]; WBIC
      WAE_length_bin[1, i*NumLengthBin+adj+2L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+2L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+2L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+2L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+2L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+2L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+2L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+3L] = WBIC[[0]]; WBIC
      WAE_length_bin[1, i*NumLengthBin+adj+3L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+3L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+3L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+3L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+3L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+3L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+3L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+4L] = WBIC[[0]]; WBIC
      WAE_length_bin[1, i*NumLengthBin+adj+4L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+4L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+4L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+4L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+4L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+4L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+4L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+5L] = WBIC[[0]]; WBIC
      WAE_length_bin[1, i*NumLengthBin+adj+5L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+5L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+5L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+5L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+5L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+5L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+5L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+6L] = WBIC[[0]]; WBIC
      WAE_length_bin[1, i*NumLengthBin+adj+6L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+6L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+6L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+6L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+6L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+6L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+6L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+7L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+7L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+7L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+7L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+7L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+7L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+7L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+7L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+8L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+8L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+8L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+8L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+8L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+8L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+8L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+8L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+9L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+9L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+9L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+9L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+9L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+9L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+9L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+9L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+10L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+10L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+10L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+10L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+10L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+10L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+10L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+10L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+11L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+11L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+11L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+11L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+11L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+11L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+11L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+11L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+12L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+12L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+12L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+12L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+12L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+12L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+12L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+12L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+13L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+13L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+13L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+13L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+13L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+13L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+13L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+13L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+14L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+14L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+14L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+14L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+14L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+14L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+14L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+14L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+15L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+15L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+15L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+15L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+15L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+15L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+15L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+15L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+16L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+16L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+16L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+16L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+16L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+16L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+16L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+16L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+17L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+17L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+17L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+17L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+17L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+17L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+17L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+17L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+18L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+18L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+18L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+18L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+18L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+18L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+18L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+18L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+19L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+19L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+19L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+19L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+19L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+19L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+19L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+19L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+20L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+20L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+20L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+20L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+20L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+20L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+20L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+20L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+21L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+21L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+21L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+21L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+21L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+21L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+21L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+21L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+22L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+22L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+22L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+22L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+22L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+22L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+22L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+22L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+23L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+23L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+23L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+23L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+23L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+23L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+23L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+23L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+24L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+24L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+24L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+24L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+24L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+24L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+24L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+24L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+25L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+25L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+25L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+25L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+25L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+25L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+25L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+25L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+26L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+26L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+26L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+26L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+26L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+26L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+26L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+26L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+27L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+27L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+27L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+27L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+27L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+27L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+27L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+27L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+28L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+28L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+28L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+28L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+28L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+28L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+28L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+28L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+29L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+29L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+29L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+29L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+29L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+29L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+29L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+29L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+30L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+30L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+30L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+30L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+30L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+30L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+30L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+30L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+31L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+31L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+31L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+31L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+31L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+31L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+31L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+31L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+32L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+32L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+32L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+32L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+32L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+32L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+32L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+32L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+33L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+33L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+33L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+33L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+33L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+33L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+33L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+33L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+34L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+34L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+34L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+34L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+34L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+34L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+34L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+34L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+35L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+35L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+35L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+35L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+35L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+35L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+35L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+35L] = Min(age)
      ...
      WAE_length_bin[0, i*NumLengthBin+adj+36L] = WBIC[[0]]; WBIC (abbrev)
      WAE_length_bin[1, i*NumLengthBin+adj+36L] = N_ELEMENTS(Length_Gro); N of fish
      WAE_length_bin[2, i*NumLengthBin+adj+36L] = WBIC[[0]]; WBIC
      WAE_length_bin[3, i*NumLengthBin+adj+36L] = SurveyYear[[0]]; year
      WAE_length_bin[4, i*NumLengthBin+adj+36L] = Max(length)
      WAE_length_bin[5, i*NumLengthBin+adj+36L] = Min(length)
      WAE_length_bin[6, i*NumLengthBin+adj+36L] = Max(age)
      WAE_length_bin[7, i*NumLengthBin+adj+36L] = Min(age)
      ...
      IF SizeLT100count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj] = Min(age[[male]])
      ...
      IF Size100to120count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+1L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+1L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+1L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+1L] = Min(age[[male]])
      ...
      IF Size120to140count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+2L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+2L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+2L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+2L] = Min(age[[male]])
      ...
      IF Size140to160count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+3L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+3L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+3L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+3L] = Min(age[[male]])
      ...
      IF Size160to180count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+4L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+4L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+4L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+4L] = Min(age[[male]])
      ...
      IF Size180to200count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+5L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+5L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+5L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+5L] = Min(age[[male]])
      ...
      IF Size200to220count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+6L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+6L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+6L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+6L] = Min(age[[male]])
      ...
      IF Size220to240count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+7L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+7L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+7L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+7L] = Min(age[[male]])
      ...
      IF Size240to260count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+8L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+8L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+8L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+8L] = Min(age[[male]])
      ...
      IF Size260to280count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+9L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+9L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+9L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+9L] = Min(age[[male]])
      ...
      IF Size280to300count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+10L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+10L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+10L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+10L] = Min(age[[male]])
      ...
      IF Size300to320count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+11L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+11L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+11L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+11L] = Min(age[[male]])
      ...
      IF Size320to340count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+12L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+12L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+12L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+12L] = Min(age[[male]])
      ...
      IF Size340to360count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+13L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+13L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+13L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+13L] = Min(age[[male]])
      ...
      IF Size360to380count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+14L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+14L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+14L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+14L] = Min(age[[male]])
      ...
      IF Size380to400count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+15L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+15L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+15L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+15L] = Min(age[[male]])
      ...
      IF Size400to420count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+16L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+16L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+16L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+16L] = Min(age[[male]])
      ...
      IF Size420to440count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+17L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+17L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+17L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+17L] = Min(age[[male]])
      ...
      IF Size440to460count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+18L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+18L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+18L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+18L] = Min(age[[male]])
      ...
      IF Size460to480count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+19L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+19L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+19L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+19L] = Min(age[[male]])
      ...
      IF Size480to500count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+20L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+20L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+20L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+20L] = Min(age[[male]])
      ...
      IF Size500to520count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+21L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+21L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+21L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+21L] = Min(age[[male]])
      ...
      IF Size520to540count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+22L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+22L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+22L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+22L] = Min(age[[male]])
      ...
      IF Size540to560count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+23L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+23L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+23L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+23L] = Min(age[[male]])
      ...
      IF Size560to580count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+24L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+24L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+24L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+24L] = Min(age[[male]])
      ...
      IF Size580to600count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+25L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+25L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+25L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+25L] = Min(age[[male]])
      ...
      IF Size600to620count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+26L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+26L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+26L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+26L] = Min(age[[male]])
      ...
      IF Size620to640count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+27L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+27L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+27L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+27L] = Min(age[[male]])
      ...
      IF Size640to660count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+28L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+28L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+28L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+28L] = Min(age[[male]])
      ...
      IF Size660to680count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+29L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+29L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+29L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+29L] = Min(age[[male]])
      ...
      IF Size680to700count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+30L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+30L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+30L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+30L] = Min(age[[male]])
      ...
      IF Size700to720count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+31L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+31L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+31L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+31L] = Min(age[[male]])
      ...
      IF Size720to740count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+32L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+32L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+32L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+32L] = Min(age[[male]])
      ...
      IF Size740to760count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+33L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+33L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+33L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+33L] = Min(age[[male]])
      ...
      IF Size760to780count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+34L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+34L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+34L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+34L] = Min(age[[male]])
      ...
      IF Size780to800count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+35L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+35L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+35L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+35L] = Min(age[[male]])
      ...
      IF SizeGE800count GT 0 THEN BEGIN
        ...
        WAE_length_bin[37, i*NumLengthBin+adj+36L] = Max(length[[male]])
        WAE_length_bin[38, i*NumLengthBin+adj+36L] = Min(length[[male]])
        WAE_length_bin[39, i*NumLengthBin+adj+36L] = Max(age[[male]])
        WAE_length_bin[40, i*NumLengthBin+adj+36L] = Min(age[[male]])
      ...
      IF SizeLT100count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj] = Min(age[[female]])
      ...
      IF Size100to120count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+1L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+1L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+1L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+1L] = Min(age[[female]])
      ...
      IF Size120to140count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+2L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+2L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+2L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+2L] = Min(age[[female]])
      ...
      IF Size140to160count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+3L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+3L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+3L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+3L] = Min(age[[female]])
      ...
      IF Size160to180count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+4L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+4L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+4L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+4L] = Min(age[[female]])
      ...
      IF Size180to200count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+5L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+5L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+5L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+5L] = Min(age[[female]])
      ...
      IF Size200to220count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+6L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+6L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+6L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+6L] = Min(age[[female]])
      ...
      IF Size220to240count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+7L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+7L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+7L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+7L] = Min(age[[female]])
      ...
      IF Size240to260count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+8L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+8L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+8L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+8L] = Min(age[[female]])
      ...
      IF Size260to280count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+9L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+9L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+9L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+9L] = Min(age[[female]])
      ...
      IF Size280to300count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+10L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+10L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+10L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+10L] = Min(age[[female]])
      ...
      IF Size300to320count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+11L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+11L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+11L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+11L] = Min(age[[female]])
      ...
      IF Size320to340count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+12L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+12L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+12L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+12L] = Min(age[[female]])
      ...
      IF Size340to360count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+13L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+13L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+13L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+13L] = Min(age[[female]])
      ...
      IF Size360to380count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+14L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+14L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+14L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+14L] = Min(age[[female]])
      ...
      IF Size380to400count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+15L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+15L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+15L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+15L] = Min(age[[female]])
      ...
      IF Size400to420count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+16L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+16L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+16L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+16L] = Min(age[[female]])
      ...
      IF Size420to440count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+17L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+17L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+17L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+17L] = Min(age[[female]])
      ...
      IF Size440to460count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+18L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+18L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+18L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+18L] = Min(age[[female]])
      ...
      IF Size460to480count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+19L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+19L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+19L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+19L] = Min(age[[female]])
      ...
      IF Size480to500count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+20L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+20L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+20L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+20L] = Min(age[[female]])
      ...
      IF Size500to520count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+21L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+21L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+21L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+21L] = Min(age[[female]])
      ...
      IF Size520to540count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+22L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+22L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+22L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+22L] = Min(age[[female]])
      ...
      IF Size540to560count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+23L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+23L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+23L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+23L] = Min(age[[female]])
      ...
      IF Size560to580count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+24L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+24L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+24L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+24L] = Min(age[[female]])
      ...
      IF Size580to600count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+25L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+25L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+25L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+25L] = Min(age[[female]])
      ...
      IF Size600to620count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+26L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+26L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+26L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+26L] = Min(age[[female]])
      ...
      IF Size620to640count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+27L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+27L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+27L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+27L] = Min(age[[female]])
      ...
      IF Size640to660count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+28L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+28L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+28L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+28L] = Min(age[[female]])
      ...
      IF Size660to680count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+29L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+29L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+29L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+29L] = Min(age[[female]])
      ...
      IF Size680to700count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+30L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+30L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+30L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+30L] = Min(age[[female]])
      ...
      IF Size700to720count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+31L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+31L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+31L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+31L] = Min(age[[female]])
      ...
      IF Size720to740count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+32L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+32L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+32L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+32L] = Min(age[[female]])
      ...
      IF Size740to760count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+33L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+33L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+33L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+33L] = Min(age[[female]])
      ...
      IF Size760to780count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+34L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+34L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+34L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+34L] = Min(age[[female]])
      ...
      IF Size780to800count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+35L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+35L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+35L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+35L] = Min(age[[female]])
      ...
      IF SizeGE800count GT 0 THEN BEGIN
        ...
        WAE_length_bin[70, i*NumLengthBin+adj+36L] = Max(length[[female]])
        WAE_length_bin[71, i*NumLengthBin+adj+36L] = Min(length[[female]])
        WAE_length_bin[72, i*NumLengthBin+adj+36L] = Max(age[[female]])
        WAE_length_bin[73, i*NumLengthBin+adj+36L] = Min(age[[female]])
      ...
      ; Mean length-at-age
      ; All
      age0 = WHERE((AGE EQ 0), Age0count)
      age1 = WHERE((AGE EQ 1), Age1count)
      age2 = WHERE((AGE EQ 2), AGE2count)
      age3 = WHERE((AGE EQ 3), AGE3count)
      age4 = WHERE((AGE EQ 4), AGE4count)
      age5 = WHERE((AGE EQ 5), AGE5count)
      age6 = WHERE((AGE EQ 6), AGE6count)
      age7 = WHERE((AGE EQ 7), AGE7count)
      age8 = WHERE((AGE EQ 8), AGE8count)
      age9 = WHERE((AGE EQ 9), AGE9count)
      age10 = WHERE((AGE EQ 10), AGE10count)
      age11 = WHERE((AGE EQ 11), AGE11count)
      AGE12 = WHERE((AGE EQ 12), AGE12count)
      AGE13 = WHERE((AGE EQ 13), AGE13count)
      AGE14 = WHERE((AGE EQ 14), AGE14count)
      AGE15 = WHERE((AGE EQ 15), AGE15count)
      age16 = WHERE((AGE EQ 16), Age16count)
      age17 = WHERE((AGE EQ 17), AGE17count)
      age18 = WHERE((AGE EQ 18), AGE18count)
      age19 = WHERE((AGE EQ 19), AGE19count)
      age20 = WHERE((AGE EQ 20), AGE20count)
      age21 = WHERE((AGE EQ 21), AGE21count)
      age22 = WHERE((AGE EQ 22), AGE22count)
      age23 = WHERE((AGE EQ 23), AGE23count)
      age24 = WHERE((AGE EQ 24), AGE24count)
      age25 = WHERE((AGE EQ 25), AGE25count)
      age26 = WHERE((AGE EQ 26), AGE26count)

      ; Male
      age0M = WHERE((AGE EQ 0) AND (SEX EQ 0), Age0Mcount)
      age1M = WHERE((AGE EQ 1) AND (SEX EQ 0), Age1Mcount)
      age2M = WHERE((AGE EQ 2) AND (SEX EQ 0), AGE2Mcount)
      age3M = WHERE((AGE EQ 3) AND (SEX EQ 0), AGE3Mcount)
      age4M = WHERE((AGE EQ 4) AND (SEX EQ 0), AGE4Mcount)
      age5M = WHERE((AGE EQ 5) AND (SEX EQ 0), AGE5Mcount)
      age6M = WHERE((AGE EQ 6) AND (SEX EQ 0), AGE6Mcount)
      age7M = WHERE((AGE EQ 7) AND (SEX EQ 0), AGE7Mcount)
      age8M = WHERE((AGE EQ 8) AND (SEX EQ 0), AGE8Mcount)
      age9M = WHERE((AGE EQ 9) AND (SEX EQ 0), AGE9Mcount)
      age10M = WHERE((AGE EQ 10) AND (SEX EQ 0), AGE10Mcount)
      age11M = WHERE((AGE EQ 11) AND (SEX EQ 0), AGE11Mcount)
      age12M = WHERE((AGE EQ 12) AND (SEX EQ 0), AGE12Mcount)
      age13M = WHERE((AGE EQ 13) AND (SEX EQ 0), AGE13Mcount)
      age14M = WHERE((AGE EQ 14) AND (SEX EQ 0), AGE14Mcount)
      age15M = WHERE((AGE EQ 15) AND (SEX EQ 0), AGE15Mcount)
      age16M = WHERE((AGE EQ 16) AND (SEX EQ 0), AGE16Mcount)
      age17M = WHERE((AGE EQ 17) AND (SEX EQ 0), AGE17Mcount)
      age18M = WHERE((AGE EQ 18) AND (SEX EQ 0), AGE18Mcount)
      age19M = WHERE((AGE EQ 19) AND (SEX EQ 0), AGE19Mcount)
      age20M = WHERE((AGE EQ 20) AND (SEX EQ 0), AGE20Mcount)
      age21M = WHERE((AGE EQ 21) AND (SEX EQ 0), AGE21Mcount)
      age22M = WHERE((AGE EQ 22) AND (SEX EQ 0), AGE22Mcount)
      age23M = WHERE((AGE EQ 23) AND (SEX EQ 0), AGE23Mcount)
      age24M = WHERE((AGE EQ 24) AND (SEX EQ 0), AGE24Mcount)
      age25M = WHERE((AGE EQ 25) AND (SEX EQ 0), AGE25Mcount)
      age26M = WHERE((AGE EQ 26) AND (SEX EQ 0), AGE26Mcount)

      ; Female
      age0F = WHERE((AGE EQ 0) AND (SEX EQ 1), Age0Fcount)
      age1F = WHERE((AGE EQ 1) AND (SEX EQ 1), Age1Fcount)
      age2F = WHERE((AGE EQ 2) AND (SEX EQ 1), AGE2Fcount)
      age3F = WHERE((AGE EQ 3) AND (SEX EQ 1), AGE3Fcount)
      age4F = WHERE((AGE EQ 4) AND (SEX EQ 1), AGE4Fcount)
      age5F = WHERE((AGE EQ 5) AND (SEX EQ 1), AGE5Fcount)
      age6F = WHERE((AGE EQ 6) AND (SEX EQ 1), AGE6Fcount)
      age7F = WHERE((AGE EQ 7) AND (SEX EQ 1), AGE7Fcount)
      age8F = WHERE((AGE EQ 8) AND (SEX EQ 1), AGE8Fcount)
      age9F = WHERE((AGE EQ 9) AND (SEX EQ 1), AGE9Fcount)
      age10F = WHERE((AGE EQ 10) AND (SEX EQ 1), AGE10Fcount)
      age11F = WHERE((AGE EQ 11) AND (SEX EQ 1), AGE11Fcount)
      age12F = WHERE((AGE EQ 12) AND (SEX EQ 1), AGE12Fcount)
      age13F = WHERE((AGE EQ 13) AND (SEX EQ 1), AGE13Fcount)
      age14F = WHERE((AGE EQ 12) AND (SEX EQ 1), AGE14Fcount)
      age15F = WHERE((AGE EQ 13) AND (SEX EQ 1), AGE15Fcount)
      age16F = WHERE((AGE EQ 16) AND (SEX EQ 1), AGE16Fcount)
      age17F = WHERE((AGE EQ 17) AND (SEX EQ 1), AGE17Fcount)
      age18F = WHERE((AGE EQ 18) AND (SEX EQ 1), AGE18Fcount)
      age19F = WHERE((AGE EQ 19) AND (SEX EQ 1), AGE19Fcount)
      age20F = WHERE((AGE EQ 20) AND (SEX EQ 1), AGE20Fcount)
      age21F = WHERE((AGE EQ 21) AND (SEX EQ 1), AGE21Fcount)
      age22F = WHERE((AGE EQ 22) AND (SEX EQ 1), AGE22Fcount)
      age23F = WHERE((AGE EQ 23) AND (SEX EQ 1), AGE23Fcount)
      age24F = WHERE((AGE EQ 24) AND (SEX EQ 1), AGE24Fcount)
      age25F = WHERE((AGE EQ 25) AND (SEX EQ 1), AGE25Fcount)
      age26F = WHERE((AGE EQ 26) AND (SEX EQ 1), AGE26Fcount)


      ;all
      IF Age0count GT 0. THEN BEGIN
        WAE_size_age[3, i] = MEAN(Length[[age0]])
        WAE_size_age[4, i] = STDDEV(Length[[age0]])
        WAE_size_age[5, i] = N_ELEMENTS(Length[[age0]])
        WAE_size_age[6, i] = MAX(Length[[age0]])
        WAE_size_age[7, i] = MIN(Length[[age0]])

      ENDIF
      IF Age1count GT 0. THEN BEGIN
        WAE_size_age[8, i] = MEAN(Length[[age1]])
        WAE_size_age[9, i] = STDDEV(Length[[age1]])
        WAE_size_age[10, i] = N_ELEMENTS(Length[[age1]])
        WAE_size_age[11, i] = MAX(Length[[age1]])
        WAE_size_age[12, i] = MIN(Length[[age1]])
      ENDIF
      IF Age2count GT 0. THEN BEGIN
        WAE_size_age[13, i] = MEAN(Length[[age2]])
        WAE_size_age[14, i] = STDDEV(Length[[age2]])
        WAE_size_age[15, i] = N_ELEMENTS(Length[[age2]])
        WAE_size_age[16, i] = MAX(Length[[age2]])
        WAE_size_age[17, i] = MIN(Length[[age2]])
      ENDIF
      IF Age3count GT 0. THEN BEGIN
        WAE_size_age[18, i] = MEAN(Length[[age3]])
        WAE_size_age[19, i] = STDDEV(Length[[age3]])
        WAE_size_age[20, i] = N_ELEMENTS(Length[[age4]])
        WAE_size_age[21, i] = MAX(Length[[age3]])
        WAE_size_age[22, i] = MIN(Length[[age3]])
      ENDIF
      IF Age4count GT 0. THEN BEGIN
        WAE_size_age[23, i] = MEAN(Length[[age4]])
        WAE_size_age[24, i] = STDDEV(Length[[age4]])
        WAE_size_age[25, i] = N_ELEMENTS(Length[[age4]])
        WAE_size_age[26, i] = MAX(Length[[age4]])
        WAE_size_age[27, i] = MIN(Length[[age4]])
      ENDIF
      IF Age5count GT 0. THEN BEGIN
        WAE_size_age[28, i] = MEAN(Length[[age5]])
        WAE_size_age[29, i] = STDDEV(Length[[age5]])
        WAE_size_age[30, i] = N_ELEMENTS(Length[[age5]])
        WAE_size_age[31, i] = MAX(Length[[age5]])
        WAE_size_age[32, i] = MIN(Length[[age5]])
      ENDIF
      IF Age6count GT 0. THEN BEGIN
        WAE_size_age[33, i] = MEAN(Length[[age6]])
        WAE_size_age[34, i] = STDDEV(Length[[age6]])
        WAE_size_age[35, i] = N_ELEMENTS(Length[[age6]])
        WAE_size_age[36, i] = MAX(Length[[age6]])
        WAE_size_age[37, i] = MIN(Length[[age6]])
      ENDIF
      IF Age7count GT 0. THEN BEGIN
        WAE_size_age[38, i] = MEAN(Length[[age7]])
        WAE_size_age[39, i] = STDDEV(Length[[age7]])
        WAE_size_age[40, i] = N_ELEMENTS(Length[[age7]])
        WAE_size_age[41, i] = MAX(Length[[age7]])
        WAE_size_age[42, i] = MIN(Length[[age7]])
      ENDIF
      IF Age8count GT 0. THEN BEGIN
        WAE_size_age[43, i] = MEAN(Length[[age8]])
        WAE_size_age[44, i] = STDDEV(Length[[age8]])
        WAE_size_age[45, i] = N_ELEMENTS(Length[[age8]])
        WAE_size_age[46, i] = MAX(Length[[age8]])
        WAE_size_age[47, i] = MIN(Length[[age8]])
      ENDIF
      IF Age9count GT 0. THEN BEGIN
        WAE_size_age[48, i] = MEAN(Length[[age9]])
        WAE_size_age[49, i] = STDDEV(Length[[age9]])
        WAE_size_age[50, i] = N_ELEMENTS(Length[[age9]])
        WAE_size_age[51, i] = MAX(Length[[age9]])
        WAE_size_age[52, i] = MIN(Length[[age9]])
      ENDIF
      IF Age10count GT 0. THEN BEGIN
        WAE_size_age[53, i] = MEAN(Length[[age10]])
        WAE_size_age[54, i] = STDDEV(Length[[age10]])
        WAE_size_age[55, i] = N_ELEMENTS(Length[[age10]])
        WAE_size_age[56, i] = MAX(Length[[age10]])
        WAE_size_age[57, i] = MIN(Length[[age10]])
      ENDIF
      IF Age11count GT 0. THEN BEGIN
        WAE_size_age[58, i] = MEAN(Length[[age11]])
        WAE_size_age[59, i] = STDDEV(Length[[age11]])
        WAE_size_age[60, i] = N_ELEMENTS(Length[[age11]])
        WAE_size_age[61, i] = MAX(Length[[age11]])
        WAE_size_age[62, i] = MIN(Length[[age11]])
      ENDIF
      IF Age12count GT 0. THEN BEGIN
        WAE_size_age[63, i] = MEAN(Length[[age12]])
        WAE_size_age[64, i] = STDDEV(Length[[age12]])
        WAE_size_age[65, i] = N_ELEMENTS(Length[[age12]])
        WAE_size_age[66, i] = MAX(Length[[age12]])
        WAE_size_age[67, i] = MIN(Length[[age12]])
      ENDIF
      IF Age13count GT 0. THEN BEGIN
        WAE_size_age[68, i] = MEAN(Length[[age13]])
        WAE_size_age[69, i] = STDDEV(Length[[age13]])
        WAE_size_age[70, i] = N_ELEMENTS(Length[[age13]])
        WAE_size_age[71, i] = MAX(Length[[age13]])
        WAE_size_age[72, i] = MIN(Length[[age13]])
      ENDIF
      IF Age14count GT 0. THEN BEGIN
        WAE_size_age[73, i] = MEAN(Length[[age14]])
        WAE_size_age[74, i] = STDDEV(Length[[age14]])
        WAE_size_age[75, i] = N_ELEMENTS(Length[[age14]])
        WAE_size_age[76, i] = MAX(Length[[age14]])
        WAE_size_age[77, i] = MIN(Length[[age14]])
      ENDIF
      IF Age15count GT 0. THEN BEGIN
        WAE_size_age[78, i] = MEAN(Length[[age15]])
        WAE_size_age[79, i] = STDDEV(Length[[age15]])
        WAE_size_age[80, i] = N_ELEMENTS(Length[[age15]])
        WAE_size_age[81, i] = MAX(Length[[age15]])
        WAE_size_age[82, i] = MIN(Length[[age15]])
      ENDIF
      IF Age16count GT 0. THEN BEGIN
        WAE_size_age[83, i] = MEAN(Length[[age16]])
        WAE_size_age[84, i] = STDDEV(Length[[age16]])
        WAE_size_age[85, i] = N_ELEMENTS(Length[[age16]])
        WAE_size_age[86, i] = MAX(Length[[age16]])
        WAE_size_age[87, i] = MIN(Length[[age16]])
      ENDIF
      IF Age17count GT 0. THEN BEGIN
        WAE_size_age[88, i] = MEAN(Length[[age17]])
        WAE_size_age[89, i] = STDDEV(Length[[age17]])
        WAE_size_age[90, i] = N_ELEMENTS(Length[[age17]])
        WAE_size_age[91, i] = MAX(Length[[age17]])
        WAE_size_age[92, i] = MIN(Length[[age17]])
      ENDIF
      IF Age18count GT 0. THEN BEGIN
        WAE_size_age[93, i] = MEAN(Length[[age18]])
        WAE_size_age[94, i] = STDDEV(Length[[age18]])
        WAE_size_age[95, i] = N_ELEMENTS(Length[[age18]])
        WAE_size_age[96, i] = MAX(Length[[age18]])
        WAE_size_age[97, i] = MIN(Length[[age18]])
      ENDIF
      IF Age19count GT 0. THEN BEGIN
        WAE_size_age[98, i] = MEAN(Length[[age19]])
        WAE_size_age[99, i] = STDDEV(Length[[age19]])
        WAE_size_age[100, i] = N_ELEMENTS(Length[[age19]])
        WAE_size_age[101, i] = MAX(Length[[age19]])
        WAE_size_age[102, i] = MIN(Length[[age19]])
      ENDIF
      IF Age20count GT 0. THEN BEGIN
        WAE_size_age[103, i] = MEAN(Length[[age20]])
        WAE_size_age[104, i] = STDDEV(Length[[age20]])
        WAE_size_age[105, i] = N_ELEMENTS(Length[[age20]])
        WAE_size_age[106, i] = MAX(Length[[age20]])
        WAE_size_age[107, i] = MIN(Length[[age20]])
      ENDIF
      IF Age21count GT 0. THEN BEGIN
        WAE_size_age[108, i] = MEAN(Length[[age21]])
        WAE_size_age[109, i] = STDDEV(Length[[age21]])
        WAE_size_age[110, i] = N_ELEMENTS(Length[[age21]])
        WAE_size_age[111, i] = MAX(Length[[age21]])
        WAE_size_age[112, i] = MIN(Length[[age21]])
      ENDIF
      IF Age22count GT 0. THEN BEGIN
        WAE_size_age[113, i] = MEAN(Length[[age22]])
        WAE_size_age[114, i] = STDDEV(Length[[age22]])
        WAE_size_age[115, i] = N_ELEMENTS(Length[[age22]])
        WAE_size_age[116, i] = MAX(Length[[age22]])
        WAE_size_age[117, i] = MIN(Length[[age22]])
      ENDIF
      IF Age23count GT 0. THEN BEGIN
        WAE_size_age[118, i] = MEAN(Length[[age23]])
        WAE_size_age[119, i] = STDDEV(Length[[age23]])
        WAE_size_age[120, i] = N_ELEMENTS(Length[[age23]])
        WAE_size_age[121, i] = MAX(Length[[age23]])
        WAE_size_age[122, i] = MIN(Length[[age23]])
      ENDIF
      IF Age24count GT 0. THEN BEGIN
        WAE_size_age[123, i] = MEAN(Length[[age24]])
        WAE_size_age[124, i] = STDDEV(Length[[age24]])
        WAE_size_age[125, i] = N_ELEMENTS(Length[[age24]])
        WAE_size_age[126, i] = MAX(Length[[age24]])
        WAE_size_age[127, i] = MIN(Length[[age24]])
      ENDIF
      IF Age25count GT 0. THEN BEGIN
        WAE_size_age[128, i] = MEAN(Length[[age25]])
        WAE_size_age[129, i] = STDDEV(Length[[age25]])
        WAE_size_age[130, i] = N_ELEMENTS(Length[[age25]])
        WAE_size_age[131, i] = MAX(Length[[age25]])
        WAE_size_age[132, i] = MIN(Length[[age25]])
      ENDIF
      IF Age26count GT 0. THEN BEGIN
        WAE_size_age[133, i] = MEAN(Length[[age26]])
        WAE_size_age[134, i] = STDDEV(Length[[age26]])
        WAE_size_age[135, i] = N_ELEMENTS(Length[[age26]])
        WAE_size_age[136, i] = MAX(Length[[age26]])
        WAE_size_age[137, i] = MIN(Length[[age26]])
      ENDIF


      ; Males
      IF Age0Mcount GT 0. THEN BEGIN
        WAE_size_age[138, i] = MEAN(Length[[age0M]])
        WAE_size_age[139, i] = STDDEV(Length[[age0M]])
        WAE_size_age[140, i] = N_ELEMENTS(Length[[age0M]])
        WAE_size_age[141, i] = MAX(Length[[age0M]])
        WAE_size_age[142, i] = MIN(Length[[age0M]])
      ENDIF
      IF Age1Mcount GT 0. THEN BEGIN
        WAE_size_age[143, i] = MEAN(Length[[age1M]])
        WAE_size_age[144, i] = STDDEV(Length[[age1M]])
        WAE_size_age[145, i] = N_ELEMENTS(Length[[age1M]])
        WAE_size_age[146, i] = MAX(Length[[age1M]])
        WAE_size_age[147, i] = MIN(Length[[age1M]])
      ENDIF
      IF Age2Mcount GT 0. THEN BEGIN
        WAE_size_age[148, i] = MEAN(Length[[age2M]])
        WAE_size_age[149, i] = STDDEV(Length[[age2M]])
        WAE_size_age[150, i] = N_ELEMENTS(Length[[age2M]])
        WAE_size_age[151, i] = MAX(Length[[age2M]])
        WAE_size_age[152, i] = MIN(Length[[age2M]])
      ENDIF
      IF Age3Mcount GT 0. THEN BEGIN
        WAE_size_age[153, i] = MEAN(Length[[age3M]])
        WAE_size_age[154, i] = STDDEV(Length[[age3M]])
        WAE_size_age[155, i] = N_ELEMENTS(Length[[age4M]])
        WAE_size_age[156, i] = MAX(Length[[age3M]])
        WAE_size_age[157, i] = MIN(Length[[age3M]])
      ENDIF
      IF Age4Mcount GT 0. THEN BEGIN
        WAE_size_age[158, i] = MEAN(Length[[age4M]])
        WAE_size_age[159, i] = STDDEV(Length[[age4M]])
        WAE_size_age[160, i] = N_ELEMENTS(Length[[age4M]])
        WAE_size_age[161, i] = MAX(Length[[age4M]])
        WAE_size_age[162, i] = MIN(Length[[age4M]])
      ENDIF
      IF Age5Mcount GT 0. THEN BEGIN
        WAE_size_age[163, i] = MEAN(Length[[age5M]])
        WAE_size_age[164, i] = STDDEV(Length[[age5M]])
        WAE_size_age[165, i] = N_ELEMENTS(Length[[age5M]])
        WAE_size_age[166, i] = MAX(Length[[age5M]])
        WAE_size_age[167, i] = MIN(Length[[age5M]])
      ENDIF
      IF Age6Mcount GT 0. THEN BEGIN
        WAE_size_age[168, i] = MEAN(Length[[age6M]])
        WAE_size_age[169, i] = STDDEV(Length[[age6M]])
        WAE_size_age[170, i] = N_ELEMENTS(Length[[age6M]])
        WAE_size_age[171, i] = MAX(Length[[age6M]])
        WAE_size_age[172, i] = MIN(Length[[age6M]])
      ENDIF
      IF Age7Mcount GT 0. THEN BEGIN
        WAE_size_age[173, i] = MEAN(Length[[age7M]])
        WAE_size_age[174, i] = STDDEV(Length[[age7M]])
        WAE_size_age[175, i] = N_ELEMENTS(Length[[age7M]])
        WAE_size_age[176, i] = MAX(Length[[age7M]])
        WAE_size_age[177, i] = MIN(Length[[age7M]])
      ENDIF
      IF Age8Mcount GT 0. THEN BEGIN
        WAE_size_age[178, i] = MEAN(Length[[age8M]])
        WAE_size_age[179, i] = STDDEV(Length[[age8M]])
        WAE_size_age[180, i] = N_ELEMENTS(Length[[age8M]])
        WAE_size_age[181, i] = MAX(Length[[age8M]])
        WAE_size_age[182, i] = MIN(Length[[age8M]])
      ENDIF
      IF Age9Mcount GT 0. THEN BEGIN
        WAE_size_age[183, i] = MEAN(Length[[age9M]])
        WAE_size_age[184, i] = STDDEV(Length[[age9M]])
        WAE_size_age[185, i] = N_ELEMENTS(Length[[age9M]])
        WAE_size_age[186, i] = MAX(Length[[age9M]])
        WAE_size_age[187, i] = MIN(Length[[age9M]])
      ENDIF
      IF Age10Mcount GT 0. THEN BEGIN
        WAE_size_age[188, i] = MEAN(Length[[age10M]])
        WAE_size_age[189, i] = STDDEV(Length[[age10M]])
        WAE_size_age[190, i] = N_ELEMENTS(Length[[age10M]])
        WAE_size_age[191, i] = MAX(Length[[age10M]])
        WAE_size_age[192, i] = MIN(Length[[age10M]])
      ENDIF
      IF Age11Mcount GT 0. THEN BEGIN
        WAE_size_age[193, i] = MEAN(Length[[age11M]])
        WAE_size_age[194, i] = STDDEV(Length[[age11M]])
        WAE_size_age[195, i] = N_ELEMENTS(Length[[age11M]])
        WAE_size_age[196, i] = MAX(Length[[age11M]])
        WAE_size_age[197, i] = MIN(Length[[age11M]])
      ENDIF
      IF Age12Mcount GT 0. THEN BEGIN
        WAE_size_age[198, i] = MEAN(Length[[age12M]])
        WAE_size_age[199, i] = STDDEV(Length[[age12M]])
        WAE_size_age[200, i] = N_ELEMENTS(Length[[age12M]])
        WAE_size_age[201, i] = MAX(Length[[age12M]])
        WAE_size_age[202, i] = MIN(Length[[age12M]])
      ENDIF
      IF Age13Mcount GT 0. THEN BEGIN
        WAE_size_age[203, i] = MEAN(Length[[age13M]])
        WAE_size_age[204, i] = STDDEV(Length[[age13M]])
        WAE_size_age[205, i] = N_ELEMENTS(Length[[age13M]])
        WAE_size_age[206, i] = MAX(Length[[age13M]])
        WAE_size_age[207, i] = MIN(Length[[age13M]])
      ENDIF
      IF Age14Mcount GT 0. THEN BEGIN
        WAE_size_age[208, i] = MEAN(Length[[age14M]])
        WAE_size_age[209, i] = STDDEV(Length[[age14M]])
        WAE_size_age[210, i] = N_ELEMENTS(Length[[age14M]])
        WAE_size_age[211, i] = MAX(Length[[age14M]])
        WAE_size_age[212, i] = MIN(Length[[age14M]])
      ENDIF
      IF Age15Mcount GT 0. THEN BEGIN
        WAE_size_age[213, i] = MEAN(Length[[age15M]])
        WAE_size_age[214, i] = STDDEV(Length[[age15M]])
        WAE_size_age[215, i] = N_ELEMENTS(Length[[age15M]])
        WAE_size_age[216, i] = MAX(Length[[age15M]])
        WAE_size_age[217, i] = MIN(Length[[age15M]])
      ENDIF
      IF Age16Mcount GT 0. THEN BEGIN
        WAE_size_age[218, i] = MEAN(Length[[age16M]])
        WAE_size_age[219, i] = STDDEV(Length[[age16M]])
        WAE_size_age[220, i] = N_ELEMENTS(Length[[age16M]])
        WAE_size_age[221, i] = MAX(Length[[age16M]])
        WAE_size_age[222, i] = MIN(Length[[age16M]])
      ENDIF
      IF Age17Mcount GT 0. THEN BEGIN
        WAE_size_age[223, i] = MEAN(Length[[age17M]])
        WAE_size_age[224, i] = STDDEV(Length[[age17M]])
        WAE_size_age[225, i] = N_ELEMENTS(Length[[age17M]])
        WAE_size_age[226, i] = MAX(Length[[age17M]])
        WAE_size_age[227, i] = MIN(Length[[age17M]])
      ENDIF
      IF Age18Mcount GT 0. THEN BEGIN
        WAE_size_age[228, i] = MEAN(Length[[age18M]])
        WAE_size_age[229, i] = STDDEV(Length[[age18M]])
        WAE_size_age[230, i] = N_ELEMENTS(Length[[age18M]])
        WAE_size_age[231, i] = MAX(Length[[age18M]])
        WAE_size_age[232, i] = MIN(Length[[age18M]])
      ENDIF
      IF Age19Mcount GT 0. THEN BEGIN
        WAE_size_age[233, i] = MEAN(Length[[age19M]])
        WAE_size_age[234, i] = STDDEV(Length[[age19M]])
        WAE_size_age[235, i] = N_ELEMENTS(Length[[age19M]])
        WAE_size_age[236, i] = MAX(Length[[age19M]])
        WAE_size_age[237, i] = MIN(Length[[age19M]])
      ENDIF
      IF Age20Mcount GT 0. THEN BEGIN
        WAE_size_age[238, i] = MEAN(Length[[age20M]])
        WAE_size_age[239, i] = STDDEV(Length[[age20M]])
        WAE_size_age[240, i] = N_ELEMENTS(Length[[age20M]])
        WAE_size_age[241, i] = MAX(Length[[age20M]])
        WAE_size_age[242, i] = MIN(Length[[age20M]])
      ENDIF
      IF Age21Mcount GT 0. THEN BEGIN
        WAE_size_age[243, i] = MEAN(Length[[age21M]])
        WAE_size_age[244, i] = STDDEV(Length[[age21M]])
        WAE_size_age[245, i] = N_ELEMENTS(Length[[age21M]])
        WAE_size_age[246, i] = MAX(Length[[age21M]])
        WAE_size_age[247, i] = MIN(Length[[age21M]])
      ENDIF
      IF Age22Mcount GT 0. THEN BEGIN
        WAE_size_age[248, i] = MEAN(Length[[age22M]])
        WAE_size_age[249, i] = STDDEV(Length[[age22M]])
        WAE_size_age[250, i] = N_ELEMENTS(Length[[age22M]])
        WAE_size_age[251, i] = MAX(Length[[age22M]])
        WAE_size_age[252, i] = MIN(Length[[age22M]])
      ENDIF
      IF Age23Mcount GT 0. THEN BEGIN
        WAE_size_age[253, i] = MEAN(Length[[age23M]])
        WAE_size_age[254, i] = STDDEV(Length[[age23M]])
        WAE_size_age[255, i] = N_ELEMENTS(Length[[age23M]])
        WAE_size_age[256, i] = MAX(Length[[age23M]])
        WAE_size_age[257, i] = MIN(Length[[age23M]])
      ENDIF
      IF Age24Mcount GT 0. THEN BEGIN
        WAE_size_age[258, i] = MEAN(Length[[age24M]])
        WAE_size_age[259, i] = STDDEV(Length[[age24M]])
        WAE_size_age[260, i] = N_ELEMENTS(Length[[age24M]])
        WAE_size_age[261, i] = MAX(Length[[age24M]])
        WAE_size_age[262, i] = MIN(Length[[age24M]])
      ENDIF
      IF Age25Mcount GT 0. THEN BEGIN
        WAE_size_age[263, i] = MEAN(Length[[age25M]])
        WAE_size_age[264, i] = STDDEV(Length[[age25M]])
        WAE_size_age[265, i] = N_ELEMENTS(Length[[age25M]])
        WAE_size_age[266, i] = MAX(Length[[age25M]])
        WAE_size_age[267, i] = MIN(Length[[age25M]])
      ENDIF
      IF Age26Mcount GT 0. THEN BEGIN
        WAE_size_age[268, i] = MEAN(Length[[age26M]])
        WAE_size_age[269, i] = STDDEV(Length[[age26M]])
        WAE_size_age[270, i] = N_ELEMENTS(Length[[age26M]])
        WAE_size_age[271, i] = MAX(Length[[age26M]])
        WAE_size_age[272, i] = MIN(Length[[age26M]])
      ENDIF
      ...
      IF Age0Fcount GT 0. THEN BEGIN
        WAE_size_age[273, i] = MEAN(Length[[age0F]])
        WAE_size_age[274, i] = STDDEV(Length[[age0F]])
        WAE_size_age[275, i] = N_ELEMENTS(Length[[age0F]])
        WAE_size_age[276, i] = MAX(Length[[age0F]])
        WAE_size_age[277, i] = MIN(Length[[age0F]])
      ENDIF
      IF Age1Fcount GT 0. THEN BEGIN
        WAE_size_age[278, i] = MEAN(Length[[age1F]])
        WAE_size_age[279, i] = STDDEV(Length[[age1F]])
        WAE_size_age[280, i] = N_ELEMENTS(Length[[age1F]])
        WAE_size_age[281, i] = MAX(Length[[age1F]])
        WAE_size_age[282, i] = MIN(Length[[age1F]])
      ENDIF
      IF Age2Fcount GT 0. THEN BEGIN
        WAE_size_age[283, i] = MEAN(Length[[age2F]])
        WAE_size_age[284, i] = STDDEV(Length[[age2F]])
        WAE_size_age[285, i] = N_ELEMENTS(Length[[age2F]])
        WAE_size_age[286, i] = MAX(Length[[age2F]])
        WAE_size_age[287, i] = MIN(Length[[age2F]])
      ENDIF
      IF Age3Fcount GT 0. THEN BEGIN
        WAE_size_age[288, i] = MEAN(Length[[age3F]])
        WAE_size_age[289, i] = STDDEV(Length[[age3F]])
        WAE_size_age[290, i] = N_ELEMENTS(Length[[age3F]])
        WAE_size_age[291, i] = MAX(Length[[age3F]])
        WAE_size_age[292, i] = MIN(Length[[age3F]])
      ENDIF
      IF Age4Fcount GT 0. THEN BEGIN
        WAE_size_age[293, i] = MEAN(Length[[age4F]])
        WAE_size_age[294, i] = STDDEV(Length[[age4F]])
        WAE_size_age[295, i] = N_ELEMENTS(Length[[age4F]])
        WAE_size_age[296, i] = MAX(Length[[age4F]])
        WAE_size_age[297, i] = MIN(Length[[age4F]])
      ENDIF
      IF Age5Fcount GT 0. THEN BEGIN
        WAE_size_age[298, i] = MEAN(Length[[age5F]])
        WAE_size_age[299, i] = STDDEV(Length[[age5F]])
        WAE_size_age[300, i] = N_ELEMENTS(Length[[age5F]])
        WAE_size_age[301, i] = MAX(Length[[age5F]])
        WAE_size_age[302, i] = MIN(Length[[age5F]])
      ENDIF
      IF Age6Fcount GT 0. THEN BEGIN
        WAE_size_age[303, i] = MEAN(Length[[age6F]])
        WAE_size_age[304, i] = STDDEV(Length[[age6F]])
        WAE_size_age[305, i] = N_ELEMENTS(Length[[age6F]])
        WAE_size_age[306, i] = MAX(Length[[age6F]])
        WAE_size_age[307, i] = MIN(Length[[age6F]])
      ENDIF
      IF Age7Fcount GT 0. THEN BEGIN
        WAE_size_age[308, i] = MEAN(Length[[age7F]])
        WAE_size_age[309, i] = STDDEV(Length[[age7F]])
        WAE_size_age[310, i] = N_ELEMENTS(Length[[age7F]])
        WAE_size_age[311, i] = MAX(Length[[age7F]])
        WAE_size_age[312, i] = MIN(Length[[age7F]])
      ENDIF
      IF Age8Fcount GT 0. THEN BEGIN
        WAE_size_age[313, i] = MEAN(Length[[age8F]])
        WAE_size_age[314, i] = STDDEV(Length[[age8F]])
        WAE_size_age[315, i] = N_ELEMENTS(Length[[age8F]])
        WAE_size_age[316, i] = MAX(Length[[age8F]])
        WAE_size_age[317, i] = MIN(Length[[age8F]])
      ENDIF
      IF Age9Fcount GT 0. THEN BEGIN
        WAE_size_age[318, i] = MEAN(Length[[age9F]])
        WAE_size_age[319, i] = STDDEV(Length[[age9F]])
        WAE_size_age[320, i] = N_ELEMENTS(Length[[age9F]])
        WAE_size_age[321, i] = MAX(Length[[age9F]])
        WAE_size_age[322, i] = MIN(Length[[age9F]])
      ENDIF
      IF Age10Fcount GT 0. THEN BEGIN
        WAE_size_age[323, i] = MEAN(Length[[age10F]])
        WAE_size_age[324, i] = STDDEV(Length[[age10F]])
        WAE_size_age[325, i] = N_ELEMENTS(Length[[age10F]])
        WAE_size_age[326, i] = MAX(Length[[age10F]])
        WAE_size_age[327, i] = MIN(Length[[age10F]])
      ENDIF
      IF Age11Fcount GT 0. THEN BEGIN
        WAE_size_age[328, i] = MEAN(Length[[age11F]])
        WAE_size_age[329, i] = STDDEV(Length[[age11F]])
        WAE_size_age[330, i] = N_ELEMENTS(Length[[age11F]])
        WAE_size_age[331, i] = MAX(Length[[age11F]])
        WAE_size_age[332, i] = MIN(Length[[age11F]])
      ENDIF
      IF Age12Fcount GT 0. THEN BEGIN
        WAE_size_age[333, i] = MEAN(Length[[age12F]])
        WAE_size_age[334, i] = STDDEV(Length[[age12F]])
        WAE_size_age[335, i] = N_ELEMENTS(Length[[age12F]])
        WAE_size_age[336, i] = MAX(Length[[age12F]])
        WAE_size_age[337, i] = MIN(Length[[age12F]])
      ENDIF
      IF Age13Fcount GT 0. THEN BEGIN
        WAE_size_age[338, i] = MEAN(Length[[age13F]])
        WAE_size_age[339, i] = STDDEV(Length[[age13F]])
        WAE_size_age[340, i] = N_ELEMENTS(Length[[age13F]])
        WAE_size_age[341, i] = MAX(Length[[age13F]])
        WAE_size_age[342, i] = MIN(Length[[age13F]])
      ENDIF
      IF Age14Fcount GT 0. THEN BEGIN
        WAE_size_age[343, i] = MEAN(Length[[age14F]])
        WAE_size_age[344, i] = STDDEV(Length[[age14F]])
        WAE_size_age[345, i] = N_ELEMENTS(Length[[age14F]])
        WAE_size_age[346, i] = MAX(Length[[age14F]])
        WAE_size_age[347, i] = MIN(Length[[age14F]])
      ENDIF
      IF Age15Fcount GT 0. THEN BEGIN
        WAE_size_age[348, i] = MEAN(Length[[age15F]])
        WAE_size_age[349, i] = STDDEV(Length[[age15F]])
        WAE_size_age[350, i] = N_ELEMENTS(Length[[age15F]])
        WAE_size_age[351, i] = MAX(Length[[age15F]])
        WAE_size_age[352, i] = MIN(Length[[age15F]])
      ENDIF
      IF Age16Fcount GT 0. THEN BEGIN
        WAE_size_age[353, i] = MEAN(Length[[age16F]])
        WAE_size_age[354, i] = STDDEV(Length[[age16F]])
        WAE_size_age[355, i] = N_ELEMENTS(Length[[age16F]])
        WAE_size_age[356, i] = MAX(Length[[age16F]])
        WAE_size_age[357, i] = MIN(Length[[age16F]])
      ENDIF
      IF Age17Fcount GT 0. THEN BEGIN
        WAE_size_age[358, i] = MEAN(Length[[age17F]])
        WAE_size_age[359, i] = STDDEV(Length[[age17F]])
        WAE_size_age[360, i] = N_ELEMENTS(Length[[age17F]])
        WAE_size_age[361, i] = MAX(Length[[age17F]])
        WAE_size_age[362, i] = MIN(Length[[age17F]])
      ENDIF
      IF Age18Fcount GT 0. THEN BEGIN
        WAE_size_age[363, i] = MEAN(Length[[age18F]])
        WAE_size_age[364, i] = STDDEV(Length[[age18F]])
        WAE_size_age[365, i] = N_ELEMENTS(Length[[age18F]])
        WAE_size_age[366, i] = MAX(Length[[age18F]])
        WAE_size_age[367, i] = MIN(Length[[age18F]])
      ENDIF
      IF Age19Fcount GT 0. THEN BEGIN
        WAE_size_age[368, i] = MEAN(Length[[age19F]])
        WAE_size_age[369, i] = STDDEV(Length[[age19F]])
        WAE_size_age[370, i] = N_ELEMENTS(Length[[age19F]])
        WAE_size_age[371, i] = MAX(Length[[age19F]])
        WAE_size_age[372, i] = MIN(Length[[age19F]])
      ENDIF
      IF Age20Fcount GT 0. THEN BEGIN
        WAE_size_age[373, i] = MEAN(Length[[age20F]])
        WAE_size_age[374, i] = STDDEV(Length[[age20F]])
        WAE_size_age[375, i] = N_ELEMENTS(Length[[age20F]])
        WAE_size_age[376, i] = MAX(Length[[age20F]])
        WAE_size_age[377, i] = MIN(Length[[age20F]])
      ENDIF
      IF Age21Fcount GT 0. THEN BEGIN
        WAE_size_age[378, i] = MEAN(Length[[age21F]])
        WAE_size_age[379, i] = STDDEV(Length[[age21F]])
        WAE_size_age[380, i] = N_ELEMENTS(Length[[age21F]])
        WAE_size_age[381, i] = MAX(Length[[age21F]])
        WAE_size_age[382, i] = MIN(Length[[age21F]])
      ENDIF
      IF Age22Fcount GT 0. THEN BEGIN
        WAE_size_age[383, i] = MEAN(Length[[age22F]])
        WAE_size_age[384, i] = STDDEV(Length[[age22F]])
        WAE_size_age[385, i] = N_ELEMENTS(Length[[age22F]])
        WAE_size_age[386, i] = MAX(Length[[age22F]])
        WAE_size_age[387, i] = MIN(Length[[age22F]])
      ENDIF
      IF Age23Fcount GT 0. THEN BEGIN
        WAE_size_age[388, i] = MEAN(Length[[age23F]])
        WAE_size_age[389, i] = STDDEV(Length[[age23F]])
        WAE_size_age[390, i] = N_ELEMENTS(Length[[age23F]])
        WAE_size_age[391, i] = MAX(Length[[age23F]])
        WAE_size_age[392, i] = MIN(Length[[age23F]])
      ENDIF
      IF Age24Fcount GT 0. THEN BEGIN
        WAE_size_age[393, i] = MEAN(Length[[age24F]])
        WAE_size_age[394, i] = STDDEV(Length[[age24F]])
        WAE_size_age[396, i] = N_ELEMENTS(Length[[age24F]])
        WAE_size_age[397, i] = MAX(Length[[age24F]])
        WAE_size_age[398, i] = MIN(Length[[age24F]])
      ENDIF
      IF Age25Fcount GT 0. THEN BEGIN
        WAE_size_age[399, i] = MEAN(Length[[age25F]])
        WAE_size_age[400, i] = STDDEV(Length[[age25F]])
        WAE_size_age[401, i] = N_ELEMENTS(Length[[age25F]])
        WAE_size_age[402, i] = MAX(Length[[age25F]])
        WAE_size_age[403, i] = MIN(Length[[age25F]])
      ENDIF
      IF Age26Fcount GT 0. THEN BEGIN
        WAE_size_age[404, i] = MEAN(Length[[age26F]])
        WAE_size_age[405, i] = STDDEV(Length[[age26F]])
        WAE_size_age[406, i] = N_ELEMENTS(Length[[age26F]])
        WAE_size_age[407, i] = MAX(Length[[age26F]])
        WAE_size_age[408, i] = MIN(Length[[age26F]])
      ENDIF
